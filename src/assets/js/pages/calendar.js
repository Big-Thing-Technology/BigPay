;(function () {
  ...
  var calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
    ...
    select: function (info) {
      ...
      document.getElementById('pc-e-sdate').value =
        sdt.getFullYear() + '-' + getRound(sdt.getMonth() + 1) + '-' + getRound(sdt.getDate())
      document.getElementById('pc-e-edate').value =
        edt.getFullYear() + '-' + getRound(edt.getMonth() + 1) + '-' + getRound(edt.getDate())
    ...
    eventClick: function (info) {
      ...
      var e_date_end =
        clickedevent.end === null
          ? ''
          : " <i class='text-sm'>to</i> " + dateformat(clickedevent.end)
      e_date_end = clickedevent.end === null ? '' : e_date_end
      var e_venue =
        clickedevent.extendedProps.description === undefined ? '' : clickedevent.extendedProps.venue
  ...
  if (pc_event_edit) {
    pc_event_edit.addEventListener('click', function () {
      ...
      var e_date_end =
        calendevent.end === null ? '' : " <i class='text-sm'>to</i> " + dateformat(calendevent.end)
      e_date_end = calendevent.end === null ? '' : e_date_end
      var e_venue =
        calendevent.extendedProps.description === undefined ? '' : calendevent.extendedProps.venue
