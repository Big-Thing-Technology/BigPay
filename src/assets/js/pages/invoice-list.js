...
function floatchart() {
  ...
  const dataTable4 = new simpleDatatables.DataTable('#pc-dt-simple-4', {
    sortable: false,
  })
  ;(function () {
    ...
    var chart = new ApexCharts(
      document.querySelector('#total-invoice-1-chart'),
      total_invoice_1_chart_options
    )
    chart.render()
    ...
    var chart = new ApexCharts(
      document.querySelector('#total-invoice-2-chart'),
      total_invoice_2_chart_options
    )
    chart.render()
    ...
    var chart = new ApexCharts(
      document.querySelector('#total-invoice-3-chart'),
      total_invoice_3_chart_options
    )
    chart.render()
  })()
}
